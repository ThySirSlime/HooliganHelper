...
public class KnifeRefill : Entity
{
    ...
    public static KnifeRefill lastUsedKnifeRefill;

    private static int KnifeDashes
    {
        get => HooliganHelperModule.Session.KnifeDashes; 
        set => HooliganHelperModule.Session.KnifeDashes = value;
    }
    private static bool DashingWithKnife
    {
        get => HooliganHelperModule.Session.DashingWithKnife; 
        set => HooliganHelperModule.Session.DashingWithKnife = value;
    }
        ...
        :base(data.Position + offset)
    {
        ...
        refillSprite = data.String("refillSprite", defaultValue:"objects/HooliganHelper/KnifeRefill/kniferefill");
        outlineSprite = data.String("outlineSprite", defaultValue:"objects/HooliganHelper/KnifeRefill/knifeoutline");
    ...
    {
        if (player.Dashes < 1 || KnifeDashes < 1)
        {
