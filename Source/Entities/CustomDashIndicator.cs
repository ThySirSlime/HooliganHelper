...
namespace Celeste.Mod.HooliganHelper.Entities.Indicators;
...
public class CustomDashIndicator : Entity
{
    ...
    private void CreateIndicators()
    {
        ...
        {
            Texture = GFX.Game["util/hooliganhelper/bough"],
            Condition = () => HooliganHelperModule.Session.BoughDashes > 0
        });
        
        Indicators.Add(new Indicator
        {
            Texture = GFX.Game["util/hooliganhelper/daisy"],
            Condition = () => HooliganHelperModule.Session.DaisyDashes > 0
        });
        
        Indicators.Add(new Indicator
        {
            Texture = GFX.Game["util/hooliganhelper/bumper"],
            Condition = () => HooliganHelperModule.Session.BumperDashes > 0
        });
        
        Indicators.Add(new Indicator
        {
            Texture = GFX.Game["util/hooliganhelper/huh"],
            Condition = () => HooliganHelperModule.Session.MetamorphosisDashes > 0
        });
        
        Indicators.Add(new Indicator
        {
            Texture = GFX.Game["util/hooliganhelper/knife"],
            Condition = () => HooliganHelperModule.Session.KnifeDashes > 0
        });
    }
    ...
    public override void Update()
    {
        ...
        if (!SceneAs<Level>().InCutscene)
        {
            ...
            if (entity is { Dead: false } && HooliganHelperModule.Settings.ShowCustomDashIndicators)
            {
                isVisible = true;
            }
        }
